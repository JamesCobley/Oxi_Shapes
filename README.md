# Oxi_Shapes
This repository contains the [Julia](https://julialang.org/) or [Python](https://www.python.org/)-scripted source code for the preprint entitled "Oxi-Shapes: The Theroem-derived Proteoform Geometry". The open codebase is designed to be used in the Google [Colab](https://colab.google/) environment using the appropriate run time. 
# General scripts
